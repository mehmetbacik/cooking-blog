      ...
      <div class="recipeDetail__contentLayout">
        ...
        <div class="row align-items-center">
          <div class="col-12 col-lg-8">
            ...
            <div v-if="recipe.steps?.length" class="recipeDetail__stepsWrapper">
              <h3 class="recipeDetail__stepsTitle">Directions</h3>
              <div class="recipeDetail__stepsList">
                <div
                  v-for="(step, idx) in recipe.steps"
                  :key="idx"
                  class="recipeDetail__stepsItem"
                  :class="{ 'is-checked': checkedSteps.has(idx) }"
                  @click="toggleStep(idx)"
                >
                  <div class="recipeDetail__stepsCheckbox">
                    <svg
                      v-if="checkedSteps.has(idx)"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                      class="check-icon"
